...
import 'primeflex/primeflex.css';                               // Utility CSS (for flex/grid)
import './../../index.css'; 
...
export default function CustomFilterDemo() {
    ...
    const renderHeader = () => {
        return (
                <div className="flex justify-content-end" style={{ gap: '0.5rem', alignItems: 'center' }}>
    ...
    const activityRowFilterTemplate = (options : ColumnFilterElementTemplateOptions) => {
    ...
    return (
        <div className="card">
            <DataTable value={customers} stripedRows  paginator rows={5} dataKey="id" filters={filters} filterDisplay="row" 
                        loading={loading} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '50rem' }} selectionMode="single"     
